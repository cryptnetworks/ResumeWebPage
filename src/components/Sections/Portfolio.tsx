  ...
  return (
    <Section className="bg-neutral-800" sectionId={SectionId.Portfolio}>
      <div className="flex flex-col gap-y-8">
        <h2 className="self-center text-xl font-bold text-white text-center">
          To see some of my work and projects, click below to navigate to my wiki or GitHub.
        </h2>
        {/* Center images and allow wrapping */}
...
//           To see some of my work and projects, click below to navigate to my wiki or GitHub.
//         </h2>
//         <div className="self-center columns-2 md:columns-3 lg:columns-4">
//           {portfolioItems.map((item, index) => {
//             const {title, image} = item;
//             return (
